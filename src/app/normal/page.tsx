...
export default function NormalPage() {
  ...
  const generateNumbers = async () => {
    ...
    try {
      const response = await fetch(`/api/random/normal?mean=${mean}&stdDev=${stdDev}&count=${count}`);
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            La distribución normal es una distribución continua que se caracteriza por su forma de campana simétrica.
            Es ampliamente utilizada en estadística y aparece naturalmente en muchos fenómenos.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div>
              <label htmlFor="mean" className="block text-sm font-medium text-gray-700 mb-2">
                Media (μ)
              </label>
              <Input
                id="mean"
                ...
                placeholder="Ej: 0"
              />
              <p className="text-xs text-gray-500 mt-1">Valor central de la distribución</p>
            </div>

            <div>
              <label htmlFor="stdDev" className="block text-sm font-medium text-gray-700 mb-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div>
                <div className="bg-gray-50 rounded-lg p-4 mb-4">
                  ...
                  <p className="text-gray-600">Media (μ): <span className="font-mono font-semibold">{result.parameters.mean}</span></p>
                  <p className="text-gray-600">Desv. Estándar (σ): <span className="font-mono font-semibold">{result.parameters.stdDev}</span></p>
